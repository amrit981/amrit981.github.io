...
/*--------------------------------------------Electronics and communicationSuru-------------------------------------------------------*/
					...
					if($row2 !=0)
					{
						while($row2=mysql_fetch_assoc($query2))
						{
							...
							if($_SESSION['email']==$demail)
							{
								...
								<html>
								<body>
								<a align="left" id="displayText" href="javascript:hideshow();"><h2>S1</h2></a> 
				...
				if($_SESSION['password']==$dpass)
				{
					...
					if($row2 !=0)
					{
						while($row2=mysql_fetch_assoc($query2))
						{
							...
							<html>
							<body>
							<a align="left" id="displayText" href="javascript:hideshow();"><h3 align="left">S1</h3></a> 
							<div id="toggleText" style="display: none">

							<?php
							echo"Chemistry: $dm1&nbsp&nbsp&nbspdate:$date1<br/>
							Electronics: $dm2<br/>
							Electrical: $dm3<br/>
							EVS: $dm4<br/>
							Computer sc: $dm5<br/>
...
if($_SESSION['branch']=="Electrical and Electronics")					
{
	mysql_connect("localhost","test","test")or die("root not connected");
	mysql_select_db("user");

	$query1  = mysql_query("SELECT * FROM eee_sign where email='".$_SESSION['email']."'");
	$row1 = mysql_num_rows($query1);
	...
	if($row1 !=0)
	{
		...
		while($row1=mysql_fetch_assoc($query1))
		{
			...
			if($_SESSION['email']==$demail)
			{
				if($_SESSION['password']==$dpass)
				{
					$query2  = mysql_query("SELECT * FROM eee_marks where email='".$_SESSION['email']."'");
					$row2 = mysql_num_rows($query2);
					...
					?></div>
					<form action="marks_updateeee.php" method="post" >
...
if($_SESSION['branch']=="Electronics and communication")					
{
	mysql_connect("localhost","test","test")or die("root not connected");
	mysql_select_db("user");

	$query1  = mysql_query("SELECT * FROM ece_sign where email='".$_SESSION['email']."'");
	$row1 = mysql_num_rows($query1);
	...
	if($row1 !=0)
	{
		...
		while($row1=mysql_fetch_assoc($query1))
		{
			...
			if($_SESSION['email']==$demail)
			{
				if($_SESSION['password']==$dpass)
				{
					$query2  = mysql_query("SELECT * FROM ece_marks where email='".$_SESSION['email']."'");
					$row2 = mysql_num_rows($query2);
					...
					?></div>
					<form action="marks_updateece.php" method="post" >
...
if($_SESSION['branch']=="Information Techonology")					
{
	mysql_connect("localhost","test","test")or die("root not connected");
	mysql_select_db("user");

	$query1  = mysql_query("SELECT * FROM it_sign where email='".$_SESSION['email']."'");
	$row1 = mysql_num_rows($query1);
	...
	if($row1 !=0)
	{
		...
		while($row1=mysql_fetch_assoc($query1))
		{
			...
			if($_SESSION['email']==$demail)
			{
				if($_SESSION['password']==$dpass)
				{
					$query2  = mysql_query("SELECT * FROM it_marks where email='".$_SESSION['email']."'");
					$row2 = mysql_num_rows($query2);
					...
					?></div>
					<form action="marks_updateit.php" method="post" >
...
if($_SESSION['branch']=="Civil engg")					
{
	mysql_connect("localhost","test","test")or die("root not connected");
	mysql_select_db("user");

	$query1  = mysql_query("SELECT * FROM civil_sign where email='".$_SESSION['email']."'");
	$row1 = mysql_num_rows($query1);
	...
	if($row1 !=0)
	{
		...
		while($row1=mysql_fetch_assoc($query1))
		{
			...
			if($_SESSION['email']==$demail)
			{
				if($_SESSION['password']==$dpass)
				{
					$query2  = mysql_query("SELECT * FROM civil_marks where email='".$_SESSION['email']."'");
					$row2 = mysql_num_rows($query2);
					...
					?></div>
					<form action="marks_updatecivil.php" method="post" >
